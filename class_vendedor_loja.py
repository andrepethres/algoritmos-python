class Vendedor:
    ...
    def __init__(self, id_vendedor="", nome_completo="", nome_usuario="", data_nasc="", login="", senha="", confirma_senha="", rg="", cpf="", cnh="", email="", telefone="", cidade="", estado="", cep="", rua="", numero_casa="", complemento="", ativo="", inativo = ""):
    ...
    def atualizar_cad_vendedor(self):
        print(">>>CADASTRE-SE<<<\n")
        print("|DADOS PESSOAIS|\n")
        self._id = input("ID vendedor:")
        self._nome_completo = input("Digite seu nome completo:")
    ...
    def excluir_vendedor(self, id_vendedor):
...
if __name__ == '__main__':  
    ...
    vendedor.atualizar_cad_vendedor()
    vendedor.vizualizar_vendedor()
